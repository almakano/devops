...
zcat /home/*/www/*/logs/*log*.gz | grep '0x%5B%5D=' | awk '{print $2}' | sort | uniq >> /etc/ipset/blacklist_web.txt;
cat /home/*/www/*/logs/*.log | grep '0x%5B%5D=' | awk '{print $2}' | sort | uniq >> /etc/ipset/blacklist_web.txt;
